...
#define ENABLE_UART3_TERMINAL           0       /* Enable terminal to use UART3 and UART0 for command i/o */
 ...
 */
#define USE_REDUCED_PRINTF        1     ///< XXX Configure your printf version here

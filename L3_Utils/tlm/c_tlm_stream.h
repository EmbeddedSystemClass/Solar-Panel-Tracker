...
/**
 * Decodes telemetry stream line by line and sets the component variables
 * according to the stream.  This can be useful to take a stream from a file
 * saved on disk and write the variables based on the stream.
 *
 * @param line One line of stream. Call this function for for all lines of a stream.
 * @returns c_true when a new stream begins to decode.
 *
 * @warning The line(string) is tokenized, so it will be modified by this function.
 */

...
/**
       * XXX Question one
       * My first approach was to store current degree of the two servos here
       * But I always seem to get a error
       *
       *
       typedef xQueueHandle Light;
...
typedef struct
{
   ...
   //}Direction;
    ...
    struct {
        xQueueHandle degree_Base;
        xQueueHandle degree_Top;

       }Queue;

       /**
           * TODO: Add terminal  // xTaskHandle terminal;
           */
struct {



       xTaskHandle lightSensor;
       xTaskHandle servoSensor;
        }Task;

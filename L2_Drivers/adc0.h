 ...
 */
inline void adc0_initialize(unsigned char channelNum)
{
    ...
    switch(channelNum) {
        case 0:
            LPC_PINCON->PINSEL1 |= (1 << 14); // Initialize P0.23 as AD0.0
            break;
        case 1:
            LPC_PINCON->PINSEL1 |= (1 << 16); // Initialize P0.24 as AD0.1
            break;
        case 2:
            LPC_PINCON->PINSEL1 |= (1 << 18); // Initialize P0.25 as AD0.2
            break;
        case 3:
            LPC_PINCON->PINSEL1 |= (1 << 20); // Initialize P0.26 as AD0.3
            break;
        case 4:
            LPC_PINCON->PINSEL3 |= (3 << 28); // Initialize P1.30 as AD0.4 // Used
            break;
        case 5:
            LPC_PINCON->PINSEL3 |= (3 << 30); // Initialize P1.31 as AD0.5 //Used
            break;
        case 6:
            LPC_PINCON->PINSEL0 |= (2 << 6); // Initialize P0.3 as AD0.6
            break;
        case 7:
            LPC_PINCON->PINSEL0 |= (2 << 4); // Initialize P0.2 as AD0.7
            break;
        default:
            // Do nothing
            break;

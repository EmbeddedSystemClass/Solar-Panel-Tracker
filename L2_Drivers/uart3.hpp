 ...
 * This simply uses UART_Base, and forwards the UART3 IRQ to UART_Base::handleInterrupt()
 * This enforces Singleton class, otherwise it's a thin wrapper around UART_Base class.
 *
 * @ingroup Drivers
 */
class Uart3 : public UART_Base, public SingletonTemplate<Uart3>
{
    public:
        /**
        ...
        inline bool isReady(void) const { return mReady; }
        inline void setReady(bool r) { mReady = r; }

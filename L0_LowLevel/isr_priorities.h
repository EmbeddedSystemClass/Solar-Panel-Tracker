...
typedef enum
{
     ...
     * Be careful changing these because interrupt priorities set above
    ...
    /**
     * @{ Interrupt Priorities
     * These are used at system_initialization.cpp.
     ...
     * is not running.  If RIT is not SYSCALL-1, then all interrupts will get locked out
